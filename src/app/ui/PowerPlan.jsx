...
function PowerPlan() {
    ...
    return (
        <section className="border-b-[1px] border-stone-300 bg-stone-100 pb-8 pt-1">
            <div
                className={`du_container mb-6 mt-8 flex flex-col items-center justify-between px-2 sm:items-center md:flex-row md:items-start md:gap-3 md:px-4 lg:mb-10 lg:px-2 ${isHidden && 'sm:pb-[20px]'}`}
            >
