    ...
    return (
        <div>
            <div className="sticker-offer flex w-full flex-col items-center justify-center gap-1 p-4 text-white">
                ...
                <div className="flex flex-col rounded-full bg-white px-2 py-2 text-[10px] font-bold leading-none tracking-tighter text-[#3e5aac] sm:px-4 sm:text-[12px] md:px-5 md:text-[14px]">
